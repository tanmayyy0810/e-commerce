...
const Navbar = () => {
    ...
    return (
        <div className='flex items-center justify-between py-9 font-medium '>
            ...
            <div className='flex items-center gap-6'>
                <img onClick={() => { setShowSearch(true); navigate('/products') }} src={assets.search_icon} alt="" className='w-5 cursor-pointer' />
            ...
            <div className={`absolute top-0 right-0 bottom-0 overflow-hidden bg-white transition-all ${visible ? 'w-full' : 'w-0'}`}>
                <div className='flex flex-col text-gray-600'>
                    ...
                    <NavLink onClick={() => setVisible(false)} className='py-2 pl-6 border hover:text-black' to='/products' >PRODUCTS</NavLink>
